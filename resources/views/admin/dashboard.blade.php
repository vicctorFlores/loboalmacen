                                    ...
                                    <div class="table-responsive table-sales">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{asset('backend/img/flags/US.png')}}">
                                                    </div>
                                                </td>
                                                <td>USA</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{asset('backend/img/flags/DE.png')}}">
                                                    </div>
                                                </td>
                                                <td>Germany</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{asset('backend/img/flags/AU.png')}}">
                                                    </div>
                                                </td>
                                                <td>Australia</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{asset('backend/img/flags/GB.png')}}">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{asset('backend/img/flags/RO.png')}}">
                                                    </div>
                                                </td>
                                                <td>Romania</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{asset('backend/img/flags/BR.png')}}">
                                                    </div>
                                                </td>
                                                <td>Brasil</td>
                                                <td class="text-right">
